import React, { useCallback, useEffect, useLayoutEffect, useState, useRef, useReducer } from 'react';
...
const useClapState = (
  ...
  }, [prevCount, clapState.count, dispatch]);
...
const Usage = () => {
  ...
  const handleClick = () => {
    setTimesClapped(prevState => prevState + 1);
  }
