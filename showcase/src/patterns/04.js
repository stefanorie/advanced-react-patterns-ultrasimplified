import React, { useCallback, createContext, useLayoutEffect, useState, useContext, useEffect, useRef, useMemo } from 'react';
...
const MediumClap = ({ children, onClap, style: userStyles = {}, className }) => {
  ...
  const { clapRef, clapCountRef, clapTotalRef } = refState;
